...
Monorepo fullstack **100% local** — sem Postgres, sem Docker, sem
...
> Projeto inicializado a partir do template [claudecode-local-project-template](https://github.com/loomi/claudecode-local-project-template).
